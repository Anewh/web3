<div id="popup" class="popup">
	<div class="popup__body">
		...
		<div class="buttons-change">
		  	<button type="submit" form="form-in" class="btn sign" id="sign-in-form-btn">Sign in</button>
			<button type="submit" form="form-reg" class="btn sign" id="sign-up-form-btn">Sign up</button>
		</div>
	</div>
</div>